...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='采购订单';

-- ----------------------------
-- Records of cgorder
-- ----------------------------
INSERT INTO `cgorder` VALUES ('13', 'CGDD-20130918-001', '2013-09-19', 'dadf', '112', '1', '1', 'wcc', '2013-09-21', '0', '0', 'dadf', '2013-09-24', '0', '0', null, '0.00', '0', '3241234');
INSERT INTO `cgorder` VALUES ('14', 'CGDD-20130926-001', '2013-09-10', '系统管理员', '112', '239', '3', 'wcc', '2013-09-13', '0', '0', null, '2013-09-26', '0', '0', null, '0.00', '0', null);
...
INSERT INTO `cgorder` VALUES ('20', 'CGDD-20140113-001', '2014-01-13', 'admin', '112', '239', '001', 'admin', '2014-01-13', '0', '1', 'admin', null, '0', '0', null, '117.00', '0', null);
...
CREATE TABLE `cgorderdetail` (
  ...
  PRIMARY KEY (`id`,`orderCode`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='采购订单明细';
...
INSERT INTO `cgorderdetail` VALUES ('4', 'CGDD-20130926-001', '1', '1111', '3.00', null, '100.00', '100.00', null, null, null, '17.00', '1.87', '12.87', null);
...
INSERT INTO `cgorderdetail` VALUES ('12', 'CGDD-20140113-001', '1', 'dss', '10.00', '10.00', '10.00', '100.00', null, null, null, '17.00', '17.00', '117.00', null);
...
CREATE TABLE `ckjhcheck` (
  ...
  `StoreCode` varchar(11) DEFAULT NULL COMMENT '仓库id',
  ...
  `CheckFlag` smallint(6) DEFAULT '0' COMMENT '审核标志',
  `CheckDate` datetime DEFAULT NULL COMMENT '审核日期',
  `CheckMan` varchar(50) DEFAULT NULL COMMENT '审核人',
  `remark` varchar(100) DEFAULT NULL COMMENT '备注',
  `SettleTypeFlag` smallint(6) DEFAULT '0' COMMENT '是否当面付，0：不付，1：付',
  PRIMARY KEY (`id`,`OrderCode`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='采购入库表';
...
-- ----------------------------
INSERT INTO `ckjhcheckdetail` VALUES ('12', 'PK-20140113-001', '1', 'dss', '10.00', '100.00', '10.00', '117.00', '17.00', '17.00', null);
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='采购付款单明细';
...
-- ----------------------------
-- Procedure structure for `bak`
-- ----------------------------
DROP PROCEDURE IF EXISTS `bak`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `bak`(storeCd VARCHAR(50),ordcd VARCHAR(50),typecd int(4),supCd VARCHAR(50))
BEGIN
...
DECLARE cur1 CURSOR FOR 
    ...
    goods_loop: LOOP   
        ...
        SET costpriceTmp=0;
        SET qtyTmp=0;
				select Quantity,CostPrice into qtyTmp,costpriceTmp from ckcurrstore where StoreCode=storeCd and GoodsCode=l_GoodsCode for UPDATE;
...
-- ----------------------------
-- Procedure structure for `CkjhProc`
-- ----------------------------
DROP PROCEDURE IF EXISTS `CkjhProc`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `CkjhProc`(storeCd VARCHAR(50),ordcd VARCHAR(50),typecd int(4),supCd VARCHAR(50))
BEGIN
