...
public class PartmentController extends BaseController {
	public static Logger log=Logger.getLogger(PartmentController.class);
	...
	public void index() {
		...
		setAttr("page", Db.paginate(getParaToInt("pageNum", 1),getParaToInt("numPerPage", 20),
				"select p.id,concat(o.name,'[',o.num,']') 所属机构, concat(p.name,'[',p.num,']') 部门名称,e.usr_name 部门主管,p.remark 备注 ",
