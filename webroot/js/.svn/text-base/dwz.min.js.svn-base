...
$.pdialog.open(DWZ._set.loginUrl,"login",DWZ._set.loginTitle,{mask:true,width:430,height:200});}else{
...
if(rel){
var $rel=$("#"+rel);
$rel.loadUrl($this.attr("url"),{},function(){
...
$.pdialog.closeCurrent();//close(dialog);
return false;});
if($.isFunction(op.callback))op.callback(response);}});}},
...
var close=dialog==null?false:dialog.data("close");
var go=true;
...
if(optgroups!=null&&optgroups.length>0){
	$(optgroups).each(function(){
			var $this=$(this);
			options+="<li><b>"+$this.attr("label")+"</b></li>";
			$("option",$this).each(function(){
			var option=$(this);
			options+="<li><a class=\""+ (value==option[0].value?"selected":"") +"\" href=\"#\" value=\"" + option[0].value + "\">&nbsp;&nbsp;&nbsp;&nbsp;"+option[0].text+"</a></li>";
			});
